...
- Fix any warnings you might encounter ... call `library(usethis)` and `apropos("license")`

... quick side remarks: https://thinkr-open.github.io/licensing-r/index.html#license
...
__Hint:__ It is better practice to use `Imports` rather than `Depends`. `Depends` might overwrite a previously loaded function of the same name:
